  ...
  return (
    <section style={styles.section}>
      <div style={styles.imageWrapper}>
        ...
        />
        <img
          src="/tyre replace (4).jpg"
          alt="Four professionals seated and standing around a laptop, having a focused discussion in a bright office setting with modern lighting and plants."
          style={styles.overlayImage}
          onError={handleImageError}
        />
      </div>
      <div style={styles.contentWrapper}>
        <h1 style={styles.title} className="text-3xl sm:text-4xl md:text-5xl font-bold text-start mb-4">          About Aussie Mobile Tyre – <span className="text-red-500"> Your Trusted Mobile Tyre Specialists</span>
</h1>
        <p style={styles.description}>
          At Aussie Mobile Tyre, we understand how important it is to have safe, reliable tyres—without the hassle of visiting a workshop. That’s why we bring expert tyre services directly to you, wherever you are in Melbourne’s south-eastern suburbs. Whether you need new tyres, puncture repairs, wheel balancing, or fleet maintenance, our fully equipped mobile units are ready to deliver fast, convenient solutions.
        ...
        <p style={styles.description}>
          ...
          Choose Aussie Mobile Tyre for dependable, professional, and hassle-free tyre care—because your safety and convenience are our top priorities.
        </p>
        <ul
          style={styles.checklist}
          aria-label="Reasons to choose Aussie Mobile Tyre"
        >
          <strong style={styles.checklistStrong}>
            Why Choose Aussie Mobile Tyre?
          </strong>
