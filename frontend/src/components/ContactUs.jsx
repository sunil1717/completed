...
const ContactUs = () => {
  ...
  return (
    <section className=" text-white px-4 sm:px-7 md:px-17 py-10 rounded-xl max-w-5xl mx-auto mt-16" id='contact'  style={{ backgroundColor: "#c01e1eff" }}>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <input
          ...
          className="w-full bg-transparent border border-white text-white placeholder-white px-4 py-3 rounded-full focus:outline-none focus:ring-2 focus:ring-red-400 text-sm"
          required
        />
        <input
          type="text"
