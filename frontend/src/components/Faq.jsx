...
const faqData = [
  {
    question: "1. What areas do Aussie Mobile Tyre services cover?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Our expert technicians come directly to your home, workplace, or roadside to fit new tyres on-site, saving you time and hassle compared to visiting a tyre shop.",
  },
  {
    question: "3. Can Aussie Mobile Tyre repair punctures on all tyre types?",
    answer:
  ...
  },
  {
    ...
    answer:
      "We responsibly collect and recycle old tyres to minimize environmental impact. Aussie Mobile Tyre ensures tyres are disposed of in compliance with local regulations and eco-friendly standards.",
  },
];
          ...
          <div className="lg:w-1/2" >
            <div className="mb-10">
              ...
              <p className="mb-6 text-gray-700">
                Do you have questions about Aussie Mobile Tyre Shop?
              </p>
