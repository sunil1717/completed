...
const Fleet = () => {
  const services = [
    ...
    },
    {
      ...
      image: "/tyre replace (4).jpg",
    },
    {
      icon: <BsPersonBadge size={40} className="text-red-600" />,
      title: "Experienced Technicians You Can Trust",
      description:
        "Our team has extensive experience servicing commercial and business fleets across Melbourne. We work efficiently, professionally, and with minimal disruption to your operations.",
        ...
        <div className="max-w-6xl mx-auto space-y-12">
          <div className="text-center my-8">
            ...
            <p className="mt-2 text-gray-600 max-w-xl mx-auto">
              ...
              delivered right to your location. Aussie Mobile Tyre ensures your
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8 bg-white">
            ...
            <div className="md:w-1/2 space-y-4">
              ...
              <p className="text-gray-700 text-lg">
                At Aussie Mobile Tyre, we understand that your fleet is the
                ...
                and flexible scheduling, Aussie Mobile Tyre is your fleet's
                trusted partner.
              </p>
          ...
          <div className="text-center mb-8">
            <h2 style={{ fontSize: "40px" }} className="font-semibold">
              Why Choose Aussie Mobile Tyre for Your Fleet?
            </h2>
          </div>
