      ...
      <div className="max-w-6xl mx-auto space-y-12">
        <div className="text-center my-8">
          ...
          <p className="mt-2 text-gray-600 max-w-xl mx-auto">
            Wherever You Are Stay safe on the road with thorough tyre inspections from Aussie Mobile Tyre—conveniently conducted at your home, workplace, or roadside.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-8 bg-white">
          ...
          <div className="md:w-1/2 space-y-4">
            <h3 style={{ fontSize: "40px" }} className="font-semibold">
              Expert Tyre Inspection Services Across Melbourne
            </h3>
            <p className="text-gray-700 text-lg">
              Regular tyre inspections are essential to ensure your tyres are safe, roadworthy, and performing optimally. Aussie Mobile Tyre offers professional mobile tyre inspection services across Melbourne’s south-eastern, eastern, and bayside suburbs. Whether you’re located in Glen Waverley, Dandenong, Frankston, Oakleigh, or Berwick, our skilled technicians come directly to you, checking tread depth, tyre pressure, sidewall condition, and overall tyre health. Early detection of wear or damage helps prevent blowouts and costly repairs, keeping you and your passengers safe on Melbourne’s busy roads.
            </p>
