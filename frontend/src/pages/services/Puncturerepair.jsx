      ...
      <div className="max-w-6xl mx-auto space-y-12">
        <div className="text-center my-8">
          ...
          <p className="mt-2 text-gray-600 max-w-xl mx-auto">
            Flat tyre? Aussie Mobile Tyre offers fast, reliable puncture repair
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-8 bg-white">
          ...
          <div className="md:w-1/2 space-y-4">
            <h3 style={{ fontSize: "40px" }} className="font-semibold">
              Professional Puncture Repair Across Melbourne
            </h3>
            <p className="text-gray-700 text-lg">
              Aussie Mobile Tyre specialises in quick, effective puncture repairs
