...
Mobile Tyre Shop at Your Doorstep            </h2>
            <p className="mt-2 text-gray-600 max-w-xl mx-auto">
              Looking for a local tyre shop near you? Aussie Mobile Tyre delivers professional tyre services right to your location—saving you time, money, and the hassle of visiting a workshop.
            </p>
          </div>
...
<div className="text-center mb-8">
  <h2 style={{ fontSize: "40px" }} className="font-semibold">
    Why Choose Our Mobile Tyre Shop?
  </h2>
</div>
